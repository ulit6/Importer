 ...
 * @author pawel
 */
public class OgraniczenieWiekuV6 extends OgraniczenieWieku{
    private final int ponizej;
    private final int powyzej;
    public OgraniczenieWiekuV6(int kod, String jednostka,int ponizej,int powyzej) {
        super(kod, jednostka);
    ...
    public static OgraniczenieWiekuV6 newInstance(int kod, String jednostka,int ponizej,int powyzej){
        return new OgraniczenieWiekuV6(kod, jednostka, ponizej, powyzej);
    }
}
